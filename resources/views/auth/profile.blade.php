                ...
                <div class="card-body">
                    <form action="{{ route('auth.updateProfile') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="image" id="image" accept=".png, .jpeg, .jpg, .svg, .gif, .jfif" class="form-control @error('image') is-invalid @enderror">
                            @error('image')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                            ...
                            @if (Auth::user()->image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/uploads/profile/thumb/'.Auth::user()->image) }}" class="img-fluid" alt="">
                            </div>
                            @endif
                        </div>
